<template>
	<myp-popup :show="show" pos="left" width="520rpx" leftOffset="20px" bgType="inverse" boxStyle="flex-direction:column;align-items:center;padding-left:32rpx;padding-right:32rpx;padding-top:120rpx;" @overlayClicked="toCancel">
