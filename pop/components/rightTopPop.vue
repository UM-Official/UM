<template>
	<myp-popup :show="show" pos="right" width="520rpx" topOffset="60px" bgType="inverse" boxStyle="flex-direction:column;align-items:center;padding-left:32rpx;padding-right:32rpx;padding-top:120rpx;" @overlayClicked="toCancel">
